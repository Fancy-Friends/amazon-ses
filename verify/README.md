...
| Registry | Package |
|---|---|
| npm | `@particle-academy/amazon-ses-js` (+ `@particle-academy/amazon-ses-ui`, resolved transitively) |
...
npm install @particle-academy/amazon-ses-js @particle-academy/fancy-flow
